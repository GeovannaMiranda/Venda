...
import carro from '../img/carrotora.png';
import carro2 from '../img/carro100x120.png';
import { Button } from '@material-ui/core';
import icons from 'material-icons';
function PagAnuncioCarro() {
                ...
                <div className='campo-card-flex'>
                    <div className='card-flex'>
                        <Card className='card1'>
                            <img src={carro2} id='tam-img'></img>
                            <img src={carro2} id='tam-img'></img>
                            <img src={carro2} id='tam-img'></img>
                        </Card>
                        <Card className='card2'>
                            <img src={carro} id='tam-img-principal'></img>
...
export default PagAnuncioCarro;